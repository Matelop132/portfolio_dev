      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p class="text-gray-600 dark:text-gray-400 mb-4">
            Développeur web freelance passionné avec 3 ans d'expérience. 
            Spécialisé en Vue.js, SEO et développement web moderne.
          </p>
          <div class="flex space-x-4">
            <a
              href="mailto:mateolp.developer@gmail.com"
